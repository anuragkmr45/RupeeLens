...
- `INT-008 — Implement CSV export and local backup/restore entrypoint` as a new execution.
...
- There is no earlier canonical `todo` with satisfied dependencies that is more actionable than starting `INT-008`.
