...
internal const val PARSER_FIXTURE_CATALOG_VERSION = "parser-fixtures.v1"

internal fun buildParserFixtureCatalogV1(): List<ParserFixtureCase> {
  return listOf(
...
internal data class ParserFixtureCase(
  val bodyText: String,
